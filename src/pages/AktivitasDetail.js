          ...
          <CCardBody>
            <CForm onSubmit={revisiAktivitas}>
              <div className="mb-3">
                ...
                <CFormInput type="text" id="exampleFormControlInput1" placeholder="Masukkan judul" value={judul} disabled={aktivitas.persetujuan_terakhir?.status != "revisi"} onChange={(e) => setJudul(e.target.value)} />
              </div>
              <div className="mb-3">
                ...
                <CFormTextarea
                  ...
                  value={deskripsi}
                  disabled={aktivitas.persetujuan_terakhir?.status != "revisi" || aktivitas.status == "pengajuan_ulang"}
                ></CFormTextarea>
              </div>
              <CCol className="row g-3">
                <CCol md={4}>
                  <div className="mb-3">
                    <CFormLabel htmlFor="exampleFormControlInput1" disabled={aktivitas.persetujuan_terakhir?.status != "revisi"}>
                      Kategori
                    </CFormLabel>
                    <CFormSelect aria-label="Default select example" disabled={aktivitas.persetujuan_terakhir?.status != "revisi"}>
                ...
                <CCol md={4}>
                  <div className="mb-3">
                    ...
                    <CFormInput type="datetime-local" id="exampleFormControlInput1" placeholder="Masukkan waktu mulai" value={waktu_mulai} disabled={aktivitas.persetujuan_terakhir?.status != "revisi"} />
                  </div>
                </CCol>
                <CCol md={4}>
                  <div className="mb-3">
                    <CFormLabel htmlFor="exampleFormControlInput1">Waktu Selesai</CFormLabel>
                    <CFormInput type="datetime-local" id="exampleFormControlInput1" placeholder="Masukkan waktu Selesai" value={waktu_selesai} disabled={aktivitas.persetujuan_terakhir?.status != "revisi"} />
                  </div>
                </CCol>
                <CButton color="primary" type="submit" disabled={loading || aktivitas.persetujuan_terakhir?.status != "revisi"}>
